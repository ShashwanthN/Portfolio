...
const ProjectCard = ({ project, handleProjectClick }) => {
  return (
    <motion.div
      ...
      className={`relative border-t  border-b p-4 cursor-pointer transition-all duration-150 flex flex-col justify-between`} 
      style={{
    ...
    >
      ...
      <div className="flex flex-col mt-auto">
        ...
        <motion.p
          className="mb-1 font-mono text-sm text-gray-3"
          initial={{ x: -100, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
